                  ...
                  <!DOCTYPE html>
                        <html lang="en">
                              ...
                              <body>
                                    ...
                                    <div class="cta">
                                          <a href="${process.env.ADMIN_FRONTEND_URL}">Start Exploring Now!</a>
                                    </div>
                                    </div>
                              </body>
                        </html>
                        `;
            const subject = "Vendor Verification Successful!";
...
const resendMerchantVerification = async ( req, res ) =>
{
      try {
            const { email } = req.params;
            const user = await prisma.merchant.findUniqueOrThrow( { where: { email:email } } );
...
module.exports = {verifyMerchantCode,resendMerchantVerification}